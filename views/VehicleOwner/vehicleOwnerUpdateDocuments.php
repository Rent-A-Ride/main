        ...
        <div  class="wrapper">
            <form method="post" class="form_1" enctype="multipart/form-data">
                ...
                <div class="inputBox">
                    ...
                    <label for="Insurancereceipt">Scanned Copy of Insurance</label>
        ...
        <div  class="wrapper">
            <form method="post" class="form_1" enctype="multipart/form-data">
                ...
                <div class="inputBox">
                    ...
                    <label for="Licensereceipt">Scanned Copy of License</label>
