        ...
        <div class="table-content" >
            <?php
                ...
                <div class="table-row">
                    ...
                    <div class="table-data"><button onclick="location.href='/vehicleOwner/viewVehicleProfile?id=<?= $vehicle->getVehId()?>'" class="view-button"><i class='bx bx-show bx-sm'></i> View</button></div>
