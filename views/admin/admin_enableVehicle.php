        ...
        <div class="table-content" >
            ...
            foreach ($result as $row):
                ...
                <div class="table-row <?=$row['veh_type']?>">
                    ...
                    <div class="table-data"><button data-vehId='<?php echo($row['veh_Id'])?>' data-vehNo='<?php echo($row['plate_No'])?>' class="book-button enable_vehicle"><i class="fa-regular fa-thumbs-up"></i></button></div>
                </div>
            <?php
            endforeach;
            ?>
