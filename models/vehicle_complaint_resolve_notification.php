...
class vehicle_complaint_resolve_notification extends dbModel
{
    ...
    {
        return 'vehicle_complaint_resolve_notification';
    }

    public function attributes(): array
    {
       return ['com_ID','cus_ID','cus_Name','vehicle_No','action'];
    }
