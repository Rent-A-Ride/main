...
const vehicleDisableButtons = document.querySelectorAll(".disable_vehicleowner")
    ...
    btn.addEventListener("click", function () {
        ...
        const viewdisable = htmlToElement(
            `<div class="modal-body">
                <div>
                    <p>Are You Sure You Want Disable ${vowner.voname}</p>
                    <div>
                        <form action="/admin/vehicleowner/disable" method="post" enctype="multipart/form-data" id="vehicleowner_disable">
