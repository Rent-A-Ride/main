...
const confirmbtn = document.querySelectorAll(".dpayment-confirm");
const confirmdbtn = document.querySelectorAll(".dpayment-confirmd")

confirmbtn.forEach(function (btn) {
    btn.addEventListener("click", function () {
        
        const driver_id=btn.dataset.driver_id;
        ...
        const confirmpayment = htmlToElement(
            `<div class="modal-body">
                <div>
                    ...
                    <div>
                        <form action="/admin/managedriverpayment" method="post" enctype="multipart/form-data" id="confirm_vehPayment">
                            <div> <input type="number" style="display:none" name='driver_Id' placeholder='' required  value='${vehicle.driver_id}' /> </div>
